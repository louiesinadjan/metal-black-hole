...
_NS_INLINE NS::Menu* NS::Menu::init(const String* pTitle) { return Object::sendMessage<Menu*>(this, _NS_PRIVATE_SEL(initWithTitle_), pTitle); }
...
_NS_INLINE void NS::Menu::addItem(const MenuItem* pItem) { Object::sendMessage<void>(this, _NS_PRIVATE_SEL(addItem_), pItem); }
