...
_NS_INLINE NS::MenuItem* NS::MenuItem::init() { return Object::sendMessage<NS::MenuItem*>(this, _NS_PRIVATE_SEL(init)); }
...
_NS_INLINE void NS::MenuItem::setSubmenu(const class NS::Menu* pSubmenu) { Object::sendMessage<void>(this, _NS_PRIVATE_SEL(setSubmenu_), pSubmenu); }
